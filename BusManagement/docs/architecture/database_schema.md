...
> The schema is generated by Hibernate using `ddl-auto=create-drop` in the development environment. No migration scripts (e.g., Flyway, Liquibase) exist in the current codebase.
